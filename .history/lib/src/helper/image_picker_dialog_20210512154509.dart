...
class ImagePickerDialog {
  Widget _roundedButton({required String? label, Color? bgColor, Color? txtColor}) {
    return Container(
  ...
  _openCamera(ValueChanged<File?>? onGet, BuildContext context) async {
    ...
    if (image != null) {
      File _compressed = await (_compress(File(image.path)) as F)utureOr<File>;
  ...
  _openGallery(ValueChanged<File?>? onGet, BuildContext context) async {
    ...
    if (image != null) {
      File _compressed = await (_compress(File(image.path)) as FutureOr<File>);
      _cropImage(_compressed, onGet!, context);
    }
  }
  ...
  show({ValueChanged<File?>? onGet, required BuildContext? context}) {
          ...
          child: Opacity(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () async => await _openCamera(onGet!, context),
                  ...
                  GestureDetector(
                    onTap: () async => await _openGallery(onGet!, context),
                    child: _roundedButton(
                      label: "Gallery",
                      bgColor: Theme.of(context).primaryColor,
                      txtColor: Colors.white,
