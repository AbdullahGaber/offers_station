...
//
//     final favouriteProviderModel = favouriteProviderModelFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

MyFavouriteProviderModel favouriteProviderModelFromJson(String str) =>
    MyFavouriteProviderModel.fromJson(json.decode(str));

String favouriteProviderModelToJson(MyFavouriteProviderModel data) =>
    json.encode(data.toJson());

class MyFavouriteProviderModel {
  MyFavouriteProviderModel({
  ...
  factory MyFavouriteProviderModel.fromJson(Map<String, dynamic> json) =>
      MyFavouriteProviderModel(
...
class Datum {
    ...
    factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        prodcuts: json["prodcuts"] == null ? null : List<Prodcut>.from(json["prodcuts"].map((x) => Prodcut.fromJson(x))),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "prodcuts": prodcuts == null ? null : List<dynamic>.from(prodcuts.map((x) => x.toJson())),
    };
}
