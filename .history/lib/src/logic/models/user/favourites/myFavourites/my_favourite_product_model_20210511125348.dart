...
MyFavouriteProductModel favouriteProductModelFromJson(String str) =>
    MyFavouriteProductModel.fromJson(json.decode(str));

String favouriteProductModelToJson(MyFavouriteProductModel data) =>
