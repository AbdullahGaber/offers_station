...
ReadNotificationsModel readNotificationsModelFromJson(String str) =>
    ReadNotificationsModel.fromJson(json.decode(str));

String readNotificationsModelToJson(ReadNotificationsModel data) =>
