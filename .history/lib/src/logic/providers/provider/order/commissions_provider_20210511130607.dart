import 'dart:io';
import 'package:offers_station/src/logic/models/provider/order/commisssions_payment_model.dart';
...
class CommissionsProvider with ChangeNotifier {
  ...
  Future<void> uploadCommissionImage(BuildContext context,
    ...
    var model = CommissionsPaymentModel(mainCode: mainCode, code: code, data: data, error: error).fromJson(response.data);
    if (response.statusCode == 200) {
