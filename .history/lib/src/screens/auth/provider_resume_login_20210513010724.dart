          ...
          Padding(
            ...
            child: Align(
              ...
              child: ClipRRect(
                  ...
                  child: isNetwork ? Image.network(imageUrl) : Image.file(img)
                  // FileThumb(
                  //     asset: img,
                  //     width: 300,
                  //     height: 300,
                  ...
                  ? () async {
                      if (images.length == 1) {
                        Fluttertoast.showToast(
                          msg: 'يجب ترك صورة واحدة على الأقل',
                          backgroundColor: Colors.red,
                        );
                        return;
                      }
                      await dialog.showOptionDialog(
                        msg: 'سيتم حذف الصورة نهائياً, هل أنت متأكد؟',
                        okFun: () async {
                          var isDeleted =
                              await productsProvider.deleteProductImageById(
                            context,
                            imageId: id,
