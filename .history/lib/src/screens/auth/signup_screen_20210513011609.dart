...
import 'package:offers_station/src/screens/auth/provider_resume_login.dart';
              ...
              : SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      RegisterButton(
                        color: Color(0xffF13F04),
                        title: signupProvider!.type == 0 ? 'تسجيل' : 'التالي',
                        onPressed: ((agreeRules == false &&
                            ...
                            : () async {
                                ...
                                if (signupProvider!.type == 0) {
                                } else {
                                  N.to(ProviderResumeLogin(),),
                                }
