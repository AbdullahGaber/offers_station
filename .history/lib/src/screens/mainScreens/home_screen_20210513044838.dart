...
import 'package:offers_station/src/screens/Notifications/notificationPage.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(icon: ImageIcon(AssetImage('assets/icons/notifications.png'),color: Theme.of(context).primaryColor,),onPressed: (){N.to(NotificationPage())},),
      ),
